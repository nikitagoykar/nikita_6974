...
public class AdminController {
	...
	// add
	@PostMapping("/hostel/{hostelId}/admin")
	private ResponseEntity<AdminDto> createAdmin(@PathVariable int hostelId,@RequestBody AdminDto adminDto) {
		AdminDto createdAdmin = this.adminService.createAdmin(adminDto,hostelId);
